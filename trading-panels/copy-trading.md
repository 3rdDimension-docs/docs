...
One of the frequent questions from our community is: how to Copy trading between multiple accounts? Such functionality can be very useful for proprietary trading companies and managers with multiple accounts who use 3rd Dimension as their trading tool.

## **Introduction**

The panel performs trading operations and thus can be found in the "<mark style="background-color:green;">**Trading**</mark>" group of the 3rd Dimension main menu.

<figure><img src="../.gitbook/assets/copy trading.png" alt=""><figcaption><p>Copy trading panel in a list of other panels</p></figcaption></figure>
...
* Copy-trading can work only if the 3rd Dimension terminal is launched.
...
* The Copy trading panel currently supports the following connections only: **Binance, Binance Futures, Bitfinex, Bybit, BitMEX, and Interactive Brokers**
{% endhint %}

{% hint style="warning" %}
**If you use 5 or more trading accounts** in the copy bot, we recommend disabling the '<mark style="background-color:orange;">**Order Limitation**</mark>' option. You can read more information about this feature in [**this guide**](../general-settings/general-settings.md#trading-protection)**.**
{% endhint %}
...
<figure><img src="../.gitbook/assets/image (3).png" alt=""><figcaption><p>New copy bot creation screen</p></figcaption></figure>
...
Now we should specify the dependent connection and account. To add another account for the same connection in 3rd Dimension, you should go to Connections manager, duplicate the required connection, rename it optionally, and log in with another account credentials. You may repeat this action for as many accounts as you need. Later you will see all these accounts in Child connections settings.
...
<figure><img src="../.gitbook/assets/1211.jpg" alt=""><figcaption></figcaption></figure>
